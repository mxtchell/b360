...
DATABASE_ID = "83E664CE-BD47-40C1-B3D6-C58B27714E8F"
DATASET_ID = "07fa2c04-5484-4c05-afbf-5868019431c7"
...
class FPAVarianceAnalysis:
    ...
    def query_data(self):
        ...
        actuals_query = f"""
        SELECT *
        FROM read_csv('uk_local_fpa.csv')
...
def local_uk_drivers(parameters: SkillInput):
    """Execute UK-specific FP&A Variance Analysis with Price-Volume-Mix decomposition"""
